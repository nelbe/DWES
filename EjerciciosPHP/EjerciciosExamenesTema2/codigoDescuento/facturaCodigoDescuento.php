...
<html>
  ...
  <body>
    ...
    //SI EL CARRITO ES MENOR DE 200€ 
    if ($totalcarrito<75){
        $cargo=15;
        
        if (isset($codigoIntroducido)){     
            ...
            <table>  
                <td><?=$totalcarrito?> €</td>
                <td><?=$descuentoCodigo?> €</td>
                <td><?=$iva?> €</td>
                <td><?=$iva + $totalcarrito + 15 - $descuentoCodigo?> €</td>
            </table>
              <p>Su pedido es inferior a <b>75€</b> por lo que tiene un coste de envío de <b>15€</b></p>
              <p>Ha introducido el códgio <b><?=$codigoIntroducido?></b> por lo que tiene un descuento de <b>5€</b></p>
            <?php    
            }
            
            elseif ($codigoIntroducido == "BBQ9W"){
                $descuentoCodigo = 12;
            ...
            <table>  
              ...
              <p>Su pedido es inferior a <b>75€</b> por lo que tiene un coste de envío de <b>15€</b></p>
              <p>Ha introducido el códgio <b><?=$codigoIntroducido?></b> por lo que tiene un descuento de <b>12€</b></p>
            <?php   
            }
            
            elseif ($codigoIntroducido == "AXZ1833"){
                $descuentoCodigo = 6;
            ...
            <table>  
              ...
              <p>Su pedido es inferior a <b>75€</b> por lo que tiene un coste de envío de <b>15€</b></p>
              <p>Ha introducido el códgio <b><?=$codigoIntroducido?></b> por lo que tiene un descuento de <b>6€</b></p>
            <?php    
    ...
    //SI EL CARRITO ES MAYOR DE 200€ 
        ...
        if (isset($codigoIntroducido)){     
            ...
            <table>  
                <td><?=$totalcarrito?> €</td>
                <td><?=$descuentoCodigo + $descuento_6?> €</td>
                <td><?=$iva?> €</td>
                <td><?=$iva + $totalcarrito - $descuento_6 - $descuentoCodigo?> €</td>
            </table>
    ...
    //SI EL CARRITO ES MAYOR DE 75 pero menor de 200    
    }else{
