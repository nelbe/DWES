...
<?php
  ...
  if($_POST['accion']== "Incrementar"){
            ...
            $nuevoStock = $_POST['stock'] + $_POST['cantidad'];
            
            $modificacion = "UPDATE articulo SET stock='" . $nuevoStock . "' WHERE codigo='" . $_POST['codigo'] . "';"; 
...
?>  
    ...
    <form action="#" method="post">
        ...
        ¿Desea incrementar el stock de este articulo? <input size="9" type="submit" name='accion' value="Incrementar">
    </form>
